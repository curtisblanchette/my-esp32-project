...
export function ActivityCenter({ commands, events, errors = [], suggestions = [], onResolveAdjustment, onRunAdvisor, maxItems = 5 }: RecentActivityProps): React.ReactElement {
    ...
    <div className="space-y-2">
      {onRunAdvisor && (
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-3 py-1.5 text-xs font-medium rounded-lg border border-teal-500/30 bg-teal-500/10 text-teal-400 hover:bg-teal-500/20 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer transition-colors"
        >
          {advisorRunning ? (
